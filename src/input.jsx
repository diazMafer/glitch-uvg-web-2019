    ...
    return (
      <div style={divStyle}>
        <form style={formStyle}>
          ...
          {input !== '' ? (
            <div style={divS}>
              <button label="" value="X" className="fa fa-times" style={input2Style} onClick={this.clearText} type="submit" />
              <button label="" className="fa fa-search" style={inputSearch} onClick={this.search} type="submit" />
            </div>
          ) : <button label="" className="fa fa-search hover" type="submit" /> }
        </form>
      </div>
    )
  }
